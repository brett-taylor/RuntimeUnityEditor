...
namespace RuntimeUnityEditor.Core.MaterialEditor.CodeGeneration
{
    public static class MaterialEditorCodeGenerator
    {
        ...
        private static void WriteKeywords(Material material, TextWriter writer)
        {
            ...
            foreach (MaterialEditorKeywords keyword in Enum.GetValues(typeof(MaterialEditorKeywords)))
            {
